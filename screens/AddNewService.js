...
const AddNewService = ({navigation}) => {
    ...
    return (
        <View style={{ padding: 10 }}>
            ...
            <Button textColor="white" buttonColor="#FF6699" style={{margin: 10}} mode="contained" onPress={handleUploadImage}>
                Upload Image
            </Button>
            {((imagePath!= "")&&
            ...
            <TextInput
                ...
                style={{ marginBottom: 10, borderWidth: 1, borderColor: '#ccc' }}
            />
            <Button buttonColor="#FF6699" textColor="white" mode="contained" onPress={handleAddNewService}>Add</Button>
        </View>
    );
};
