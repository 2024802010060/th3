...
const ServiceUpdate = ({ route, navigation }) => {
    ...
    return (
        <View style={{ padding: 10 }}>
            ...
            <Button style={{margin: 20}} buttonColor="#FF6699" textColor="black" mode="contained" onPress={handleUploadImage}>Change Image</Button>
            ...
            />
            <Button buttonColor="#FF6699" textColor="black" mode="contained" onPress={handleUpdateService}>Update</Button>
        </View>
    );
}
